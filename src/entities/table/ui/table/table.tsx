...
import {
  ...
  changeData,
  removeData,
} from '../../../../shared/redux/slices/data-slice';
import { getDataSelector } from '../../../../shared/redux/selectors/selectors';
import {
  useAppDispatch,
  useAppSelector,
} from '../../../../shared/redux/hooks/hooks';
...
const Table = () => {
  ...
  const { result, isLoading } = useAppSelector(getDataSelector);
  ...
  const handleChangeData = () => {
    if (data !== result) dispatch(changeData(data));
  };
